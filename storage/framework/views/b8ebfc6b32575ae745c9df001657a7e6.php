...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Gestion des Mutations'); ?> - Impôts & Domaines</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="brand">
            <img src="<?php echo e(asset('images/dgid-logo.png')); ?>" alt="DGID">
            <h5>Gestion des Mutations</h5>
        </div>
        <nav class="mt-3">
            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" title="Tableau de bord">
                <i class="bi bi-grid-1x2-fill"></i> <span>Tableau de bord</span>
            </a>
            <a href="<?php echo e(route('recherche')); ?>" class="nav-link <?php echo e(request()->routeIs('recherche') ? 'active' : ''); ?>" title="Recherche">
                <i class="bi bi-search"></i> <span>Recherche</span>
            </a>
            <a href="<?php echo e(route('imports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('imports.*') ? 'active' : ''); ?>" title="Imports Excel">
                <i class="bi bi-file-earmark-excel"></i> <span>Imports Excel</span>
            </a>
            <a href="<?php echo e(route('parcelles.index')); ?>" class="nav-link <?php echo e(request()->routeIs('parcelles.*') ? 'active' : ''); ?>" title="Parcelles">
                <i class="bi bi-geo-alt-fill"></i> <span>Parcelles</span>
            </a>
            <a href="<?php echo e(route('mutations.index')); ?>" class="nav-link <?php echo e(request()->routeIs('mutations.*') ? 'active' : ''); ?>" title="Mutations">
                <i class="bi bi-arrow-left-right"></i> <span>Mutations</span>
            </a>
            <?php if(auth()->user()->hasAnyRole(['admin', 'gestionnaire'])): ?>
            <a href="<?php echo e(route('annulations.index')); ?>" class="nav-link <?php echo e(request()->routeIs('annulations.*') ? 'active' : ''); ?>" title="Annulations">
                <i class="bi bi-x-circle"></i> <span>Annulations</span>
                <?php $pendingCount = \App\Models\MutationAnnulation::where('statut', 'en_attente')->count(); ?>
                <?php if($pendingCount > 0): ?>
                    <span class="badge bg-danger ms-2"><?php echo e($pendingCount); ?></span>
                <?php endif; ?>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('rapports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('rapports.*') ? 'active' : ''); ?>" title="Rapports">
                <i class="bi bi-file-earmark-bar-graph"></i> <span>Rapports</span>
            </a>
            <a href="<?php echo e(route('scanner')); ?>" class="nav-link <?php echo e(request()->routeIs('scanner') ? 'active' : ''); ?>" title="Scanner QR">
                <i class="bi bi-qr-code-scan"></i> <span>Scanner QR</span>
            </a>
            <hr class="mx-3" style="border-color: rgba(255,255,255,0.2);">
            <a href="<?php echo e(route('projets.index')); ?>" class="nav-link <?php echo e(request()->routeIs('projets.*') && !request()->routeIs('projets.carte') ? 'active' : ''); ?>" title="Projets">
                <i class="bi bi-building"></i> <span>Projets</span>
            </a>
            <a href="<?php echo e(route('projets.carte')); ?>" class="nav-link <?php echo e(request()->routeIs('projets.carte') ? 'active' : ''); ?>" title="Carte">
                <i class="bi bi-map"></i> <span>Carte</span>
            </a>
            <a href="<?php echo e(route('communes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('communes.*') ? 'active' : ''); ?>" title="Communes">
                <i class="bi bi-pin-map"></i> <span>Communes</span>
            </a>
            <?php if(auth()->user()->hasAnyRole(['admin', 'gestionnaire'])): ?>
            <a href="<?php echo e(route('templates.index')); ?>" class="nav-link <?php echo e(request()->routeIs('templates.*') ? 'active' : ''); ?>" title="Templates">
                <i class="bi bi-file-earmark-text"></i> <span>Templates</span>
            </a>
            <?php endif; ?>
            <?php if(auth()->user()->hasRole('admin')): ?>
            <a href="<?php echo e(route('admin.export-import')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.export-import') ? 'active' : ''); ?>" title="Export / Import">
    ...
    <div class="main-content">
        <div class="topbar">
            <h5 class="mb-0"><?php echo $__env->yieldContent('title', 'Tableau de bord'); ?></h5>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <span class="badge" style="background:#C8A951;"><?php echo e(auth()->user()->roles->first()?->name ?? 'utilisateur'); ?></span>
...
<?php /**PATH /Users/CheikhDiop/projetWeb/gestion-mutations/resources/views/layouts/app.blade.php ENDPATH**/ ?>